...
local function getG3Asset()
	if g3AssetKind ~= nil then
		return g3AssetKind, g3Asset or nil
	end
	...
	if editableLoaded then
		g3AssetKind = "Content"
		g3Asset = editableContent
		return g3AssetKind, g3Asset
	end
